...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="AUTOCUB_", case_sensitive=False, extra="ignore")

    base_url: str = Field(
        default=DEFAULT_GATEWAY_BASE_URL,
        description="Internal Kong service contract; override with AUTOCUB_BASE_URL.",
    )
